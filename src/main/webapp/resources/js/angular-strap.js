      ...
      link: function postLink(scope, element, attr, controller) {
        ...
        if(hasExoticValues) {
          controller.$parsers.push(function(viewValue) {
            // console.warn('$parser', element.attr('ng-com.rotterdam.model'), 'viewValue', viewValue);
            return viewValue ? trueValue : falseValue;
          });
          // modelValue -> $formatters -> viewValue
          controller.$formatters.push(function(modelValue) {
             // console.warn('$formatter("%s"): modelValue=%o (%o)', element.attr('ng-com.rotterdam.model'), modelValue, typeof modelValue);
        ...
        // com.rotterdam.model -> view
        controller.$render = function () {
          // console.warn('$render', element.attr('ng-com.rotterdam.model'), 'controller.$modelValue', typeof controller.$modelValue, controller.$modelValue, 'controller.$viewValue', typeof controller.$viewValue, controller.$viewValue);
        ...
        // view -> com.rotterdam.model
        element.bind(options.toggleEvent, function() {
          scope.$apply(function () {
            // console.warn('!click', element.attr('ng-com.rotterdam.model'), 'controller.$viewValue', typeof controller.$viewValue, controller.$viewValue, 'controller.$modelValue', typeof controller.$modelValue, controller.$modelValue);
            if(!isInput) {
  ...
  .directive('bsDatepicker', ["$window", "$parse", "$q", "$dateFormatter", "$dateParser", "$datepicker", function($window, $parse, $q, $dateFormatter, $dateParser, $datepicker) {
    ...
    return {
      ...
      link: function postLink(scope, element, attr, controller) {
        ...
        // Watch com.rotterdam.model for changes
        scope.$watch(attr.ngModel, function(newValue, oldValue) {
        ...
        function validateAgainstMinMaxDate(parsedDate) {
          ...
          // Only update the com.rotterdam.model when we have a valid date
          if(isValid) controller.$dateValue = parsedDate;
        }

        // viewValue -> $parsers -> modelValue
        controller.$parsers.unshift(function(viewValue) {
          // console.warn('$parser("%s"): viewValue=%o', element.attr('ng-com.rotterdam.model'), viewValue);
          // Null values should correctly reset the com.rotterdam.model value & validity
          if(!viewValue) {
          ...
          if(!parsedDate || isNaN(parsedDate.getTime())) {
            ...
            // invalidate com.rotterdam.model value
            return;
          } else {
        ...
        // viewValue -> element
        controller.$render = function() {
          // console.warn('$render("%s"): viewValue=%o', element.attr('ng-com.rotterdam.model'), controller.$viewValue);
  ...
  .directive('bsTypeahead', ["$window", "$parse", "$q", "$typeahead", "$parseOptions", function($window, $parse, $q, $typeahead, $parseOptions) {
    ...
    return {
      ...
      link: function postLink(scope, element, attr, controller) {
        ...
        // Watch com.rotterdam.model for changes
        scope.$watch(attr.ngModel, function(newValue, oldValue) {
          // console.warn('$watch', element.attr('ng-com.rotterdam.model'), newValue);
